  ...
  fluidPage(
    ...
    fluidRow(
      ...
      column(12,
             ...
             wellPanel(selectInput("COUNTRY", "Country:", choices=c("United-States","Canada","Mexico","Germany","Phillippines"
    ...
    fluidRow(
      ...
      column(3,
             ...
             wellPanel(
               ...
               radioButtons("categorical_variable","Categorical:",choices = c("EDUCATION","WORKCLASS","SEX"
